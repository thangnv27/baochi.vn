<?php /* Smarty version Smarty-3.1.17, created on 2015-04-08 14:41:21
         compiled from "/home/customer/domains/baochi.vn/public_html/app/view/default/source.tpl" */ ?>
<?php /*%%SmartyHeaderCode:92640135755163770148ed0-41272597%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e13035ecfb07cbf940aa0255ea4a146021b9537e' => 
    array (
      0 => '/home/customer/domains/baochi.vn/public_html/app/view/default/source.tpl',
      1 => 1427703328,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '92640135755163770148ed0-41272597',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_55163770307208_04586516',
  'variables' => 
  array (
    'lang' => 0,
    'title' => 0,
...
<?php if ($_valid && !is_callable('content_55163770307208_04586516')) {function content_55163770307208_04586516($_smarty_tpl) {?><?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" />
    ...
    <link href="<?php echo $_smarty_tpl->tpl_vars['siteurl']->value;?>
/public/style.css" rel="stylesheet" media="all" />
...
/source/">Nguồn tin</a>
    ...
    <div class="container bcqc-full cat-cover">
        <img src="<?php echo $_smarty_tpl->tpl_vars['source']->value['cover'];?>
" />
    </div>
    <!-- end quang cao full -->
    <!-- TAB -->
    <div class="container">
        <div class="cat-title">
            <h2><?php echo $_smarty_tpl->tpl_vars['source']->value['name'];?>
</h2>
        </div>
        <div class="clearfix"></div>
    </div>
...
" target="_blank">
                            <img class="first-cat-img" src='<?php echo $_smarty_tpl->tpl_vars['p']->value['thumbnail'];?>
' title="<?php echo $_smarty_tpl->tpl_vars['p']->value['title'];?>
" />
                        </a>
                        <div class="meta">
...
/" title="<?php echo $_smarty_tpl->tpl_vars['p']->value['title'];?>
" target="_blank">
                                <h3 class="title"><?php echo $_smarty_tpl->tpl_vars['p']->value['title'];?>
</h3>
                            </a>
                            <div class="mt5 source"><span class="icon"><img src="http://grabicon.com/icon?domain=/<?php echo $_smarty_tpl->tpl_vars['source']->value['website'];?>
" /></span><?php echo $_smarty_tpl->tpl_vars['source']->value['name'];?>
</div>
                        </div>
                    </div>
                <?php } else { ?>
                    <div class="pull-left col-345 mb15 <?php if ($_smarty_tpl->tpl_vars['p']->index%2) {?>mr22<?php }?>">
                        <div class="thumb">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['siteurl']->value;?>
/post/<?php echo $_smarty_tpl->tpl_vars['p']->value['rss_id'];?>
-<?php echo $_smarty_tpl->tpl_vars['p']->value['slug'];?>
/" title="<?php echo $_smarty_tpl->tpl_vars['p']->value['title'];?>
" target="_blank">
                                <img alt="<?php echo $_smarty_tpl->tpl_vars['p']->value['title'];?>
" height="95" width="150" src="<?php echo $_smarty_tpl->tpl_vars['p']->value['thumbnail'];?>
">
                            </a>
                        </div>
                        <div class="details">
...
" /></span><?php echo $_smarty_tpl->tpl_vars['source']->value['name'];?>
            ...
            <?php } ?>
            <div class="clearfix"></div>
            <div class="paging"><?php echo $_smarty_tpl->tpl_vars['pagelist']->value;?>
</div>
        </div>
        ...
        <div class="pull-right col-300">
            ...
            <div class="new-news">
                ...
                <div class="most-view">
                    <?php  $_smarty_tpl->tpl_vars['p'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['p']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['xemnhieu']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['p']->index=-1;
foreach ($_from as $_smarty_tpl->tpl_vars['p']->key => $_smarty_tpl->tpl_vars['p']->value) {
$_smarty_tpl->tpl_vars['p']->_loop = true;
 $_smarty_tpl->tpl_vars['p']->index++;
