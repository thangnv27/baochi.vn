...
{block name="body"}
    <div class="main page-menu" id="menu-page">
        <ul class="menu-ul">
            ...
            {if $smarty.session.user_logged_in == null}
                ...
                {/if}
            <li><a href="{$siteurl}"><span class="icon-star"></span>Danh sách Web HAY</a></li>
            ...
            <li>
                ...
                <ul class="menu-ul-sub">
                    {foreach $sources as $source}
                        <li><a href="{$siteurl}/newsbysource/{$source['id']}">{$source['name']}</a></li>
                        {/foreach}
                </ul>
            </li>
