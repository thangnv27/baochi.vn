...
<html>
    ...
    <div class="footer">
        ...
        <div class="ft-menu">
            <a href="{$siteurl}" title="Về trang chủ">Về trang chủ</a>
            <a href="{$siteurl}/mobile/webhay/" title="Web hay">Web hay</a>
            <a href="{$siteurl}/news/hot" title="Đọc nhiều">Đọc nhiều</a>
            <a href="{$siteurl}/news/hot" title="Đọc nhiều">Tâm điểm</a>
        </div>
    </div>
    <!-- END FOOTER -->
    <!-- BEGIN FIXED FOOTER -->
    <div class="footer-fix">
        ...
        {/block}
        <a href="{$siteurl}/mobile/webhay/" class="btn-footer btn-text">Web hay</a>
        ...
        <a href="{$siteurl}/user/myweb" class="btn-footer btn-text">Đã lưu</a>
    </div>
